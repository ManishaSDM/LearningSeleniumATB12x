...
public class Lab44_Selenium_Exceptions extends CommonToAll {
        ...
        public void test_selenium_exceptions() {
            ...
            driver.findElement(By.id("qwerty"));

            // org.openqa.selenium.NoSuchElementException: no such element: Unable to locate element: {"method":"css selector","selector":"#qwerty"}
